      ...
      <div className="w-full py-20 px-5 md:px-12 relative overflow-hidden about-section">
        ...
        <div className="relative max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="flex justify-center lg:justify-start">
            {/* Premium Vanes-Style Border */}
            {/* 3D Z-Direction Premium Frame */}
            {/* SUPER 3D PREMIUM IMAGE FRAME */}
            {/* Clean & Simple 3D Image Frame */}
            <div className="relative w-[260px] h-[260px] mx-auto perspective-1000 group">

              <div className="relative w-full h-full rounded-full transform-style-3d 
                  transition-all duration-500 
                  group-hover:rotate-x-3 group-hover:rotate-y-3 group-hover:scale-[1.04]">

                {/* Soft shadow ring */}
                <div className="absolute inset-0 rounded-full shadow-[0_10px_35px_rgba(0,0,0,0.25)] 
                    -z-10 translate-z-[-20px]"></div>

                {/* Simple elegant border */}
                <div className="absolute inset-0 rounded-full border-[4px] border-gray-300/60 
                    backdrop-blur-md translate-z-[20px]"></div>

                {/* Light background glow */}
                <div className="absolute inset-0 rounded-full bg-white/10 blur-xl translate-z-[-10px]"></div>
                ...
                <Image
                 ...
                 translate-z-[50px] animate-[subtleFloat_5s_ease-in-out_infinite]"
                />
              </div>
